...
public class testFx3 extends Application {
    ...
    private XYChart.Series<Number, Number> series4 = new XYChart.Series<Number, Number>();
...
//        NumberAxis yAxis = new NumberAxis(0, 50, 10);;
    ...
    private class AddToQueue implements Runnable {
        public void run() {
            try {
                ...
                dataQ1.add(dataStructure.getCpuUsage()*100);
                dataQ2.add(dataStructure.getMemoryUsage()*100);
                dataQ3.add(dataStructure.getIOUsage()*100);
                Thread.sleep(500);
    ...
    private void addDataToSeries() {
        for (int i = 0; i < 20; i++) { //-- add 20 numbers to the plot+
            ...
            series3.getData().add(new XYChart.Data<Number, Number>(xSeriesData++, dataQ3.remove()));
        }
